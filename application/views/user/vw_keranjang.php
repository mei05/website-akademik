                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="judul" type="text" value="<?= $buku['judul']; ?>" readonly class="form-control" id="judul">
                                    </div>
                                    <div class="form-group">
                                        <label for="penulis">Penulis</label>
                                        <input name="penulis" value="<?= $buku['penulis']; ?>" type="text" readonly class="form-control" id="penulis">
                                    </div>
                                    <div class="form-group">
                                        <label for="stok">Stok</label>
                                        <input name="stok" value="<?= $buku['stok']; ?>" type="text" readonly class="form-control" id="stok">
                                    </div>
                                    <div class="form-group">
